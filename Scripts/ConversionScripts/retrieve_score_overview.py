...
location_in_scores = {'mc-apc':0,'mc-api':1, 'mc-no':2,'rg-apc':3, 'rg-api':4, 'rg-no':5, 'mc-mc-apc':6, 'mc-mc-api':7, 'mc-mc-no':8,'simlex-999-apc':9,'simlex-999-api':10, 'simlex-999-no':11,}
