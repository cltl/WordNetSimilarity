...
def get_results_from_file(wnfile, max_tau, max_rho, rank_diff, rank_same, exact_scores):
    ...
    rho_comp = [[2,4,6],[8,10,12],[14,16,18]]
    tau_comp = [[20,22,24],[26,28,30],[32,34,36]]
...
def compare_results_from_wns(wnf1, wnf2):
    ...
    print 'Different ranking for different pos-strat: ', final_ranks[2]
    print 'Same ranking two pos-strats', final_ranks[3]
    print 'Exact scores and measure for tracing', final_ranks[4]
